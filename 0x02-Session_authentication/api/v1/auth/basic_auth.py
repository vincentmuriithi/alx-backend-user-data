...
class BasicAuth(Auth):
    ...
    def decode_base64_authorization_header(self,
        ...
        if base64_authentication_header is None:
            return None
        if not isinstance(base64_authentication_header, str):
            return None
        try:
            deooded = base64_authentication_header.encode("utf-8")
            ...
            if token is not None:
                ...
                if decoded is not None:
                    ...
                    if email is not None:
                        return self.user_object_form_credentials(email, pword)
        return
